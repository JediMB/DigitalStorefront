...
namespace Digital_Storefront
{
    ...
    {        
        ...
        static void DrawGUI()
        {
            ...
            GUI.DrawBox(1, 1, 49, 19, GUI.BorderStyle.Double);
            GUI.CreateTextbox(2, 2, 47, 17, numberone);

            GUI.DrawBox(66, 1, 32, 19, GUI.BorderStyle.Double);
            GUI.CreateTextbox(67, 2, 30, 17, pussycats);

            GUI.DrawBox(30, 21, 40, 21, GUI.BorderStyle.Double);
            GUI.CreateTextbox(33, 23, 34, 17, cyborgs);
