...
namespace Digital_Storefront
{
    ...
    {        
        ...
        static void DrawGUI()
        {
            ...
            GUI.DrawLineZigzag(1, 9, GUI.GetGUIWidth-2, GUI.BorderStyle.Single, GUI.ZigzagStyle.Regular, true, ConsoleColor.DarkRed, ConsoleColor.White);
            ...
            GUI.DrawLineZigzag(1, 39, GUI.GetGUIWidth-2, GUI.BorderStyle.Single, GUI.ZigzagStyle.Reversed, true, ConsoleColor.DarkRed, ConsoleColor.White);
        }
